...
int main()
{
	...
	guModel.AddLayer(DENSE_LAYER,n_mid,RELU);
	guModel.AddLayer(DENSE_LAYER,n_mid1,RELU);
	guModel.AddLayer(DENSE_LAYER,n_mid2,RELU);
	guModel.AddLayer(OUTPUT_LAYER,n_out,SOFTMAX);
	guModel.Build();
